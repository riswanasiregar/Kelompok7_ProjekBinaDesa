...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('pendaftar_bantuan', function (Blueprint $table) {
            $table->increments('pendaftar_bantuan_id'); // Primary Key
            $table->unsignedInteger('warga_id'); // FK ke tabel warga
            $table->unsignedInteger('program_id'); // FK ke tabel program_bantuan
