...
<div class="py-4">
    ...
    <div class="d-flex justify-content-between w-100 flex-wrap">
        <div class="mb-3 mb-lg-0">
            ...
            <p class="mb-0">List seluruh penerima bantuan</p>
        </div>
        <div>
            <a href="{{ route('penerima_bantuan.create') }}" class="btn btn-success text-white">
    ...
    <div class="col-12 mb-4">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div>
                                                <strong>{{ $data->warga->nama ?? 'N/A' }}</strong>
                                                @if($data->warga->no_ktp)
                                                    <br>
                                                    <small class="text-muted">NIK: {{ $data->warga->no_ktp }}</small>
                                                @endif
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        @if($data->keterangan)
                                            <small class="text-muted">{{ Str::limit($data->keterangan, 50) }}</small>
                                        @else
        ...
        <form action="{{ route('penerima_bantuan.destroy', $data->penerima_id) }}"
            ...
            <button type="submit"
                    ...
                    {{ $data->penyaluran()->exists() ? 'disabled' : '' }}>
