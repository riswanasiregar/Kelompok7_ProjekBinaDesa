    ...
    <div class="d-flex justify-content-between w-100 flex-wrap">
        ...
        <div>
            <a href="{{ route('program_bantuan.create') }}" class="btn btn-success text-white">
                <i class="far fa-question-circle me-1"></i> Tambah Program Bantuan
            </a>
        </div>
    </div>
</div>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center gap-2">
                                            <a href="{{ route('program_bantuan.edit', $data->program_id) }}" class="btn btn-info btn-sm d-flex align-items-center">
                                            ...
                                            <form action="{{ route('program_bantuan.destroy', $data->program_id) }}" method="POST" style="display:inline" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data ini?');">
                                                @csrf
                                                @method("DELETE")
