...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        ...
        <h4 class="mb-0 fw-semibold">Edit Pendaftar Bantuan</h4>
    </div>
...
<div class="card shadow-sm border-0">
    <div class="card-body p-4">
        <form action="{{ route('pendaftar-bantuan.update', $data->pendaftar_bantuan_id) }}" method="POST" class="row gy-3">
            @csrf
            @method('PUT')
            ...
            <div class="col-12 col-md-6">
                ...
                <input type="text" name="warga_name" class="form-control warga-input" list="warga-list"
                    placeholder="Ketik nama warga..." value="{{ old('warga_name', $data->warga->nama ?? '') }}"
                    autocomplete="off" required>
                <input type="hidden" name="warga_id" value="{{ old('warga_id', $data->warga_id) }}">
            ...
            <div class="col-12 col-md-6">
                ...
                <select name="program_id" class="form-select" required>
                    @foreach ($program as $p)
                        <option value="{{ $p->program_id }}" {{ old('program_id', $data->program_id) == $p->program_id ? 'selected' : '' }}>
                            {{ $p->nama_program }}
                        </option>
                    @endforeach
                </select>
            ...
            <div class="col-12 col-md-6">
                ...
                <input type="date" name="tanggal_daftar" value="{{ old('tanggal_daftar', $data->tanggal_daftar) }}" class="form-control" required>
            </div>
            ...
            <div class="col-12">
                ...
                <textarea name="keterangan" rows="3" class="form-control" placeholder="Opsional">{{ old('keterangan', $data->keterangan) }}</textarea>
            </div>
            ...
            function syncWarga() {
                ...
                if (value && optionMap[value]) {
                    ...
                    if (value.length > 0) {
                        ...
                        feedback.textContent = 'Nama tidak ditemukan. Pilih dari daftar atau tambah warga baru.';
                    } else {
                        feedback.style.display = 'none';
                    }
                }
