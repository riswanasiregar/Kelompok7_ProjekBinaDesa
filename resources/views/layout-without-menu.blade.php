...
<head>
    ...
    <title>Layout Without Menu | Materio</title>
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="d-flex">
                          <div class="flex-shrink-0 me-3">
                            <div class="avatar avatar-online">
                              <img src="{{ asset('assets-admin/img/avatars/1.png') }}" alt="alt" class="w-px-40 h-auto rounded-circle" />
                            </div>
                          </div>
                    ...
                    <li>
                      <a class="dropdown-item" href="#">
                        <span class="d-flex align-items-center">
                          <i class="icon-base ri ri-bank-card-line icon-md me-3"></i>
          ...
          <div class="content-wrapper">
            ...
            <footer class="content-footer footer bg-footer-theme">
              <div class="container-xxl">
                <div class="footer-container d-flex flex-column flex-md-row justify-content-between py-4">
                  <div>
                  ...
                  <div class="d-none d-lg-block">
                    ...
                    <a href="https://themeselection.com/item/category/bootstrap-templates/" target="_blank" class="footer-link me-4">Bootstrap Templates</a>
