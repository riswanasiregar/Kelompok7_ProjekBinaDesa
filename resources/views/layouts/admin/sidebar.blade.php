  ...
  <div class="app-brand demo">
    <a href="index.html" class="app-brand-link">
      <span class="app-brand-logo demo me-1">
       ...
       <div style="width: px; height: 72px; display: flex; align-items: center; justify-content: center;">
    <img src="{{ asset('assets-admin/img/elements/logo1.png') }}"
      ...
      <span class="app-brand-text demo menu-text fw-semibold ms-2">Bantu</span>
    </a>
